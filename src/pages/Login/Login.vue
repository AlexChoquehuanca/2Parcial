<template>
  <div class="auth-page light-blue theme--dark">
    <b-container>
      <Widget class="widget-auth mx-auto" title="<h3 class='mt-0'>Inicia sesión para entrar al sistema</h3>" customHeader>
        <p class="widget-auth-info">
          Usa tu dirección de correo para iniciar sesión.
        </p>
  ...
  methods: {
    ...
    login() {
      ...
      if (email.length !== 0 && password.length !== 0) {
        ...
        this.registerError("Por favor, complete ambos campos.");
      }
    },
    googleLogin() {
